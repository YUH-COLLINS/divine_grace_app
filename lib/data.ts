const dummyData = {
    ...
    customizations: [
        // Toppings
        { name: "Extra Cheese", price: 400, type: "topping" },
        { name: "Jalapeños", price: 300, type: "topping" },
        { name: "Onions", price: 150, type: "topping" },
        { name: "Olives", price: 250, type: "topping" },
        { name: "Mushrooms", price: 350, type: "topping" },
        { name: "Tomatoes", price: 200, type: "topping" },
        { name: "Bacon", price: 500, type: "topping" },
        { name: "Avocado", price: 600, type: "topping" },

        // Sides
        { name: "Coke", price: 500, type: "side" },
        { name: "Fries", price: 600, type: "side" },
        { name: "Garlic Bread", price: 700, type: "side" },
        { name: "Chicken Nuggets", price: 800, type: "side" },
        { name: "Iced Tea", price: 450, type: "side" },
        { name: "Salad", price: 550, type: "side" },
        { name: "Potato Wedges", price: 650, type: "side" },
        { name: "Mozzarella Sticks", price: 750, type: "side" },
        { name: "Sweet Corn", price: 400, type: "side" },
        { name: "Choco Lava Cake", price: 900, type: "side" },
    ],
